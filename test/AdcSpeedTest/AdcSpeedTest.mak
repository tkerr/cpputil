...
# AdcSpeedTest.mak
#
# MAKEFILE for Arduino Uno Adc328 module performance test application.
...
#
# The hex file is named AdcSpeedTest_<CPU>_<VARIANT> where CPU is the target
# processor, and VARIANT is the Arduino hardware variant.
#
# General build command: wmake [options] /f AdcSpeedTest.mak [targets]
#
