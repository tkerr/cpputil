...
# SortTest.mak
#
# MAKEFILE for Arduino Uno SelectionSort.c module test application.
...
#
# The hex file is named SortTest_<CPU>_<VARIANT> where CPU is the target
# processor, and VARIANT is the Arduino hardware variant.
#
# General build command: wmake [options] /f SortTest.mak [targets]
#
