...
# BcdTest.mak
#
# MAKEFILE for Arduino Uno Bcd.c module test application.
...
#
# The hex file is named BcdTest_<CPU>_<VARIANT> where CPU is the target
# processor, and VARIANT is the Arduino hardware variant.
#
# General build command: wmake [options] /f BcdTest.mak [targets]
#
