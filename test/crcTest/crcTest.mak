...
# crcTest.mak
#
# MAKEFILE for Arduino Uno crc.c module test application.
...
#
# The hex file is named crcTest_<CPU>_<VARIANT> where CPU is the target
# processor, and VARIANT is the Arduino hardware variant.
#
# General build command: wmake [options] /f crcTest.mak [targets]
#
