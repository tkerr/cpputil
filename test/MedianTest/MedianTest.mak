...
# MedianTest.mak
#
# MAKEFILE for Arduino Uno MedianFilter.c module test application.
...
#
# General build command: wmake [options] /f MedianTest.mak [targets]
#
