...
# sha256Test.mak
#
# MAKEFILE for Arduino Uno sha256 module test application.
...
#
# The hex file is named sha256Test_<CPU>_<VARIANT> where CPU is the target
# processor, and VARIANT is the Arduino hardware variant.
#
# General build command: wmake [options] /f sha256Test.mak [targets]
#
